...
urlpatterns = format_suffix_patterns([
    ...
    # url(r'^application/$',views.AppList.as_view(),name='application-list'),
    # url(r'^application/(?P<pk>[0-9]+)/$',views.AppDetail.as_view(),name='application-detail'),
    ...
    url(r'^device/(?P<pk>[0-9]+)/$',views.DeviceDetail.as_view(),name='devices-detail'),
